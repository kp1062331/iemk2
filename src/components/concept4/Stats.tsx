      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-8 text-center md:text-left">
          {stats.map((stat, i) => (
            ...
            >
              <div className="absolute left-0 top-0 w-px h-0 bg-gradient-to-b from-blue-600 to-transparent group-hover:h-full transition-all duration-700 hidden md:block" />
              <h4 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-[#111] via-gray-600 to-blue-600 mb-4 tracking-tighter drop-shadow-sm">
                {stat.value}
              </h4>
