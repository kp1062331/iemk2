...
export function Testimonials() {
  return (
    <section className="py-32 bg-[#F0EFEA] text-[#111] relative overflow-hidden border-t border-black/5">
      {/* Abstract Glow */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-red-500/5 rounded-full blur-[120px] pointer-events-none" />

      <div className="container mx-auto px-6 relative z-10">
        <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-red-600 mb-20 text-center">Client Success</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((test, i) => (
            ...
            >
              ...
              <div className="text-red-600/30 group-hover:text-red-600 transition-colors duration-500 mb-8 relative z-10">
              ...
              <div className="relative z-10">
                ...
                <p className="text-red-600 text-sm tracking-wide mt-1">{test.role}</p>
              </div>
            </motion.div>
          ))}
        </div>
