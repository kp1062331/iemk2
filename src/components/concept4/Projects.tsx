    ...
    <section className="py-32 bg-[#F9F8F4] text-[#111]">
      <div className="container mx-auto px-6">
        <div className="text-center mb-24 max-w-3xl mx-auto">
          <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-blue-600 mb-4">Featured Work</h2>
          ...
          {projects.map((project, i) => (
            ...
            >
              <div className="relative overflow-hidden rounded-[2rem] aspect-[4/3] mb-8 bg-white border border-black/5 shadow-xl">
                ...
                />
                <div className="absolute inset-0 bg-blue-500/0 mix-blend-overlay group-hover:opacity-10 transition-opacity duration-500" />
              </div>
              <p className="text-sm font-bold text-blue-600 tracking-widest uppercase mb-3">{project.category}</p>
              <h4 className="text-3xl font-bold mb-2 group-hover:text-blue-600 transition-colors">{project.client}</h4>
