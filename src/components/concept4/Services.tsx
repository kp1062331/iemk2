      ...
      <div className="container mx-auto px-6">
        <div className="mb-24 md:flex md:items-end md:justify-between">
          <div className="max-w-2xl">
            <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-red-600 mb-4">Core Services</h2>
            <h3 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1]">
              Transforming <br />
              complex challenges into <span className="text-red-600 italic">elegant solutions.</span>
            </h3>
          </div>
          <button className="hidden md:flex items-center gap-2 pb-2 border-b-2 border-black/20 font-semibold hover:text-red-600 hover:border-red-600 transition-colors text-black/80">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="w-full md:w-1/2 md:px-12">
                <p className="text-red-600 font-bold mb-4 tracking-widest text-sm uppercase">0{index + 1}</p>
                <h4 className="text-3xl md:text-5xl font-bold tracking-tight mb-6 group-hover:text-red-600 transition-colors duration-500">{service.title}</h4>
                <p className="text-xl text-black/60 mb-8 leading-relaxed max-w-md">{service.description}</p>
                <button className="flex items-center gap-2 text-lg font-semibold text-black/80 group-hover:text-red-600 transition-colors">
                  Learn more 
